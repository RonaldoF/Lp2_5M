...
public enum TipoInimigo {
	GOBLIN("Goblin", new Range(1,3), new Range(0,0), new Range(2,4)),
	ORC("Orc", new Range(2,4), new Range(0,0), new Range(3,6)),
	TROLL("Troll", new Range(3,6), new Range(0,0), new Range(4,10));
